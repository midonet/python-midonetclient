...
def main():
    ...
    bridge = mc.add_bridge().name('DHCPv6BRIDGE')\
                            .tenant_id(my_laptop).create()
    ...
    bridge_delete = mc.add_bridge().name('BRIDGE_DELETE_TEST')\
                                   .tenant_id(my_laptop).create()
    ...
    ## interface_left = host.add_host_interface_port()\
    ##                      .port_id(port_left.get_id())\
    ##                      .interface_name('leftdp')
    ## interface_left.create()
    ## interface_right = host.add_host_interface_port()\
    ##                       .port_id(port_right.get_id())\
    ##                       .interface_name('rightdp')
