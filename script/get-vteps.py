...
def main():
    ...
    if not bridge_exists:
        bridge = mc.add_bridge().name(bridge_name).tenant_id(my_laptop)\
                   .create()
    ...
    vtep = mc.add_vtep().name('My VTEP')\
                        ...
                        .management_port(vtep_management_port).create()
    print 'Created a VTEP.'

    # Add a new VTEP binding.
    #vtep_binding = vtep.add_binding()\
    #                   .port_name('in1')\
    #                   .network_id(bridge_id)
    #                   .create()
    vtep.add_binding().port_name('in1')\
                      .vlan_id(124)\
                      .network_id(bridge_id)\
                      .create()
    ...
    #print 'mgmt ip=%s, port name=%s, vlan id=%d, network id=%s' %
    #    (mgmt_ip, port_name, vlan_id, network_id)
